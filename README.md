...
| **Substack** | `substack/drafts/*.md` | 手動 | 自動化の仕組みなし。Substackのエディタに手でコピペしている |
...
- Substackの自動化は未着手。API・メール投稿など手段があるかは`~/dev/brain/06-dashboard/tasks.md`の「Substackも自動投稿できないか調査する」タスクで別途調査予定
