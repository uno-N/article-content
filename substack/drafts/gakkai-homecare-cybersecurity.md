第8回、日本在宅医療連合学会地域フォーラムで登壇してきました——登壇スライドまとめ
...
全体像はこの図です。以降は、この図のどこの話かを示しながら進めます。

![セキュリティ層の全体図（道・門・土地・家・裏道）](../../images/gakkai-20260913/slides.007.png)

### ネットワーク層について

図の「**道**」と「**門**」の部分です。ネットワーク層は以下で守られています。
...
図の「**家**」の部分です。脅威はこれらを通過して、家に辿り着きます。
...
【入られた後】= ずっと見張り続けるもの
  ...
  📓 操作ログ（記録・あとから追える）
```
次に、入られた後の守りです。入られることを前提にした層、とも言えます。
