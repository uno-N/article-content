...
今期のガイドラインでは、**MDS/SDS（Manufacturer Disclosure Statement for Medical Device Security：製造業者・サービス事業者による医療情報セキュリティ開示書）**の提出が必須になりました。

保守委託先から医療機関に提出されるもので、どんな設計・保守運用をしているかがここに明記されます。ちゃんとしているかをこの書類で確認し、責任の所在を明確にしておくことが必要です。

**ただし、書かれている内容が立派でも、実際にやってもらえなければ意味がありません。**

そして、ここが落とし穴です。

保守運用契約の多くは**準委任契約**です。準委任は「仕事を**行うこと**」を約束する契約で、「仕事の**完成**」を約束していません。だから成果が出ていなくても、「注意を払って業務は行いました」で成立してしまいます。

請負契約であれば**契約不適合責任**——約束した内容・品質を満たしていない状態に対する責任——を問えます。でも準委任には、これがありません。

では、どうするか。

**SLA（Service Level Agreement）で、水準を数字にしておくことです。**

「セキュリティアップデートは月次で適用する」「脆弱性の公表から何日以内に対応する」「障害発生時は何時間以内に一次回答する」。

こう書いてあって初めて、「満たしていない」と言えます。

ガイドラインにも、事業者がセキュリティアップデート責任を負うことは契約書・約款・SLA等に**明記されている場合のみ**とされ、記載がなければ医療機関側の責任とみなされる、とあります。

**基準がないものは、不適合にもなりません。**

MDS/SDSで設計を確認し、SLAで水準を決める。この2つはセットです。
...
そして、**SLAに水準が数字で書かれているか**。前半で触れたとおり、保守運用契約の多くは準委任契約なので、契約不適合責任を問えません。水準を書いておかないと「満たしていない」とすら言えなくなります。
...
1. **MDS/SDSとSLAを見せてください。** ガイドラインの要件と、どこがどう対応していますか。水準は数字で書かれていますか
