...
9月13日、その続きを、学会の会場で話してきました。第8回 日本在宅医療連合学会 地域フォーラム。90分のセッションで、厚生労働省の室長と並んでの登壇でした。

5月の記事は「考え方」の話でした。今回は、そこから一歩進めます。

**攻撃そのものを分類して、ひとつずつに対策を紐づける。**

これをやらないと、セキュリティの話はいつまでも「気をつけましょう」で終わります。気をつけようがないものに気をつけろと言われても、現場は動けません。
...
ここが大事なところで、**脅威は分類できる**んです。分類すると、「この脅威に噛み合う脆弱性はどれか」が見える。見えたら、そこだけ塞げばいい。

医療情報セキュリティの軸で、4つに分けました。
...
順に見ていきます。事例は全部、実際に日本の医療機関で起きたものです。

---

## THREAT I — 不正アクセス

正規の権限がない人がアクセスすること、すべてを不正アクセスと言います。だから、これといろんな攻撃手法の組み合わせで起こります。
